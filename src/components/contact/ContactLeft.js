...
const ContactLeft = () => {
  return (
    <div className="w-full lgl:w-[35%] h-[800px] bg-gradient-to-r from-[bodyColor] to-[#fffff0] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
      <img
